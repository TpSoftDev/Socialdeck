...
class SDeckControl {
  ...
  static const double controlXXS = SDeckSize.sizeXXXS; // controlXXS → sizeXXXS (2.0)
  static const double controlXS = SDeckSize.sizeXXS; // controlXS → sizeXXS (4.0)
  ...
  static const double controlXXL = SDeckSize.sizeXXL; // controlXXL → sizeXXL (48.0)
}
