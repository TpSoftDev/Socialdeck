/*--------------------------------------------------------------- color_palette.dart ---------------------------------------------------------------*/
// A comprehensive collection of color constants used throughout the Social Deck application.
// These colors are derived from the Figma design system and provide
// consistent theming across the app with exact color values and naming.
/*-------------------------------------------------------------------------------------------------------------------------------------------*/
...
class SDeckColorPalette {
  SDeckColorPalette._(); // Private constructor to prevent instantiation

  //************************************************ Primary Colors ************************************************//
  //--------------------------------------------------------------- Bright Coral ---------------------------------------------------------------//
  //(+ Errors)
  static const MaterialColor brightCoral = MaterialColor(
    0xFFFF6F61, // 500 as primary color
    <int, Color>{
  ...
  static const MaterialColor vibrantYellow = MaterialColor(
    0xFFFFC107, // 500 as primary color
    <int, Color>{
  ...
  static const MaterialColor skyBlue = MaterialColor(
    0xFF56CCF2, // 500 as primary color
    <int, Color>{
  ...
  static const MaterialColor slateGray = MaterialColor(
    0xFF1C2838, // 500 as primary color
    <int, Color>{
